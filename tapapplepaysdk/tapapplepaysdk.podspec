#
#  Be sure to run `pod spec lint tapapplepaysdk.podspec' to ensure this is a
...
Go all the way until Apple Pay tokenisation data."
  ...
  spec.homepage     = "https://github.com/Tap-Payments/tapapplepaysdk"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapApplePaySDK.git", :tag => "#{spec.version}" }
